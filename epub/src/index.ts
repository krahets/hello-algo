 ...
 * 1. Clone docs branch to build/epub directory
...
async function prepareDocsBranch(): Promise<string> {
  ...
  // Check if build/epub directory already exists
...
async function main() {
  ...
  // If output path not provided, auto-generate filename: hello-algo_{docLang}_{codeLang}.epub
