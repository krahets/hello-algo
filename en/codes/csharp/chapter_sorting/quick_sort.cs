...
public class quick_sort {
    ...
    public void Test() {
        ...
        Console.WriteLine("After quick sorting, nums = " + string.Join(", ", nums));

        /* Quick sort (median pivot optimization) */
        int[] nums1 = [2, 4, 1, 0, 3, 5];
        QuickSortMedian.QuickSort(nums1, 0, nums1.Length - 1);
        Console.WriteLine("After quick sorting (median pivot optimization), nums1 = " + string.Join(", ", nums1));

        /* Quick sort (tail recursion optimization) */
        int[] nums2 = [2, 4, 1, 0, 3, 5];
        QuickSortTailCall.QuickSort(nums2, 0, nums2.Length - 1);
        Console.WriteLine("After quick sorting (tail recursion optimization), nums2 = " + string.Join(", ", nums2));
    }
}
