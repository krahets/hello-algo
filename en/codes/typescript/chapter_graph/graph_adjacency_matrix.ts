...
class GraphAdjMat {
    vertices: number[]; // Vertex list, elements represent "vertex value", index represents "vertex index"
    adjMat: number[][]; // Adjacency matrix, row and column indices correspond to "vertex index"
