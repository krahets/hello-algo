...
/* Find vertex corresponding node */
...
void removeEdgeHelper(AdjListNode *head, Vertex *vet) {
    ...
    // Search for vet corresponding node in the linked list
    ...
    if (cur == NULL)
        return;
    // Remove vet corresponding node from the linked list
    pre->next = cur->next;
    // Free memory
    free(cur);
}
...
void removeVertex(GraphAdjList *graph, Vertex *vet) {
    ...
    // Shift vertices after this vertex forward to fill the gap
    int i;
