...
// Assume maximum matrix row and column count is 100
#define MAX_SIZE 100
...
int main() {
    ...
    int n = 4, m = 4; // Matrix capacity is MAX_SIZE * MAX_SIZE, effective row and column count = n * m

    // Brute force search
    int res = minPathSumDFS(grid, n - 1, m - 1);
    printf("Minimum path sum from the top-left to the bottom-right corner = %d\n", res);
