...
// Below is the median-optimized quick sort
...
// Below is the tail-recursion optimized quick sort
...
int main() {
    ...
    printf("After quick sort, nums =");
    printArray(nums, size);

    /* Quick sort (median pivot optimization) */
    int nums1[] = {2, 4, 1, 0, 3, 5};
    quickSortMedian(nums1, 0, size - 1);
    printf("Quick sort (median pivot optimization) completed, nums = ");
    printArray(nums1, size);

    /* Quick sort (tail recursion optimization) */
    int nums2[] = {2, 4, 1, 0, 3, 5};
    quickSortTailCall(nums2, 0, size - 1);
    printf("Quick sort (tail recursion optimization) completed, nums = ");
    printArray(nums1, size);
