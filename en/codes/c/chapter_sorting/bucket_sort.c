...
void bucketSort(float nums[], int n) {
    ...
    int *sizes = malloc(k * sizeof(int));          // Record the size of each bucket
    float **buckets = malloc(k * sizeof(float *)); // Dynamic array of arrays (buckets)
