...
fun main() {
    ...
    println("Quick sort completed, nums = ${nums.contentToString()}")

    /* Quick sort (median pivot optimization) */
    val nums1 = intArrayOf(2, 4, 1, 0, 3, 5)
    quickSortMedian(nums1, 0, nums1.size - 1)
    println("Quick sort (median pivot optimization) completed, nums1 = ${nums1.contentToString()}")

    /* Quick sort (tail recursion optimization) */
    val nums2 = intArrayOf(2, 4, 1, 0, 3, 5)
    quickSortTailCall(nums2, 0, nums2.size - 1)
    println("Quick sort (tail recursion optimization) completed, nums2 = ${nums2.contentToString()}")
}