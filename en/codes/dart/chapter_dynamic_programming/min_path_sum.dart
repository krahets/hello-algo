...
int minPathSumDFS(List<List<int>> grid, int i, int j) {
  ...
  if (i < 0 || j < 0) {
    // In Dart, the int type is a fixed-range integer, there is no value representing "infinity"
...
// Brute force search
  ...
  print("Minimum path sum from the top-left to the bottom-right corner = $res");
