...
### 常数阶 $O(1)$ {data-toc-label="常数阶 O(1)"}
...
### 线性阶 $O(n)$ {data-toc-label="线性阶 O(n)"}
...
### 平方阶 $O(n^2)$ {data-toc-label="平方阶O(n^2)"}
...
### 指数阶 $O(2^n)$ {data-toc-label="指数阶 O(2^n)"}
...
### 对数阶 $O(\log n)$ {data-toc-label="对数阶 O(log n)"}
...
### 线性对数阶 $O(n \log n)$ {data-toc-label="线性对数阶 O(nlog n)"}
...
### 阶乘阶 $O(n!)$ {data-toc-label="阶乘阶 O(n!)"}
