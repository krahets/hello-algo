...
=== "Cangjie"
    ...
    /* 初始化列表 */
    // 无初始值
    let nums1 = ArrayList<Int64>();
    // 有初始值
    let numbers = [1, 3, 2, 5, 4]
    let nums = ArrayList<Int64>(numbers)
    let nums2 = ArrayList<Int64>(5)
...
=== "Cangjie"
    ...
    ```cangjie title="list.cj"
    /* 拼接两个列表 */
    let nums1 = ArrayList<Int64>([6, 8, 7, 10, 9])
    nums.appendAll(nums1) // 将列表 nums1 拼接到 nums 之后
    println(nums)
    ```
