...
// Предположим, что максимальное число строк и столбцов матрицы равно 100
#define MAX_SIZE 100
...
int main() {
    ...
    int n = 4, m = 4; // Вместимость матрицы равна MAX_SIZE * MAX_SIZE, а число действительных строк и столбцов равно n * m

    // Полный перебор
    int res = minPathSumDFS(grid, n - 1, m - 1);
    printf("Минимальная сумма пути от левого верхнего до правого нижнего угла равна %d\n", res);
