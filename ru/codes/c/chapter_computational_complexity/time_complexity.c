...
int main(int argc, char *argv[]) {
    ...
    printf("Количество операций константной сложности = %d\n", count);
    ...
    count = exponential(n);
    printf("Количество операций экспоненциальной сложности (итеративная реализация) = %d\n", count);
    count = expRecur(n);
    printf("Количество операций экспоненциальной сложности (рекурсивная реализация) = %d\n", count);

    count = logarithmic(n);
    printf("Количество операций логарифмической сложности (итеративная реализация) = %d\n", count);
    count = logRecur(n);
    printf("Количество операций логарифмической сложности (рекурсивная реализация) = %d\n", count);

    count = linearLogRecur(n);
    printf("Количество операций линейно-логарифмической сложности (рекурсивная реализация) = %d\n", count);

    count = factorialRecur(n);
    printf("Количество операций факториальной сложности (рекурсивная реализация) = %d\n", count);
