...
int main() {
    ...
    printf("После завершения быстрой сортировки (оптимизация медианным опорным элементом) nums = ");
    printArray(nums1, size);

    /* Быстрая сортировка (оптимизация глубины рекурсии) */
    int nums2[] = {2, 4, 1, 0, 3, 5};
    quickSortTailCall(nums2, 0, size - 1);
    printf("После завершения быстрой сортировки (оптимизация глубины рекурсии) nums = ");
    printArray(nums1, size);
