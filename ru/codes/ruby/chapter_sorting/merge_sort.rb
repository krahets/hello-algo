...
def merge(nums, left, mid, right)
  # Интервал левого подмассива равен [left, mid], интервал правого подмассива равен [mid+1, right]
  # Создать временный массив tmp для хранения результата после объединения
