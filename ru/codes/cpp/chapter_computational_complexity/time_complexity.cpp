...
int main() {
    ...
    cout << "Количество операций константной сложности = " << count << endl;
    ...
    count = exponential(n);
    cout << "Количество операций экспоненциальной сложности (итеративная реализация) = " << count << endl;
    count = expRecur(n);
    cout << "Количество операций экспоненциальной сложности (рекурсивная реализация) = " << count << endl;

    count = logarithmic(n);
    cout << "Количество операций логарифмической сложности (итеративная реализация) = " << count << endl;
    count = logRecur(n);
    cout << "Количество операций логарифмической сложности (рекурсивная реализация) = " << count << endl;

    count = linearLogRecur(n);
    cout << "Количество операций линейно-логарифмической сложности (рекурсивная реализация) =" << count << endl;

    count = factorialRecur(n);
    cout << "Количество операций факториальной сложности (рекурсивная реализация) =" << count << endl;
