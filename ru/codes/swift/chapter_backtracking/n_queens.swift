...
func nQueens(n: Int) -> [[[String]]] {
    ...
    var cols = Array(repeating: false, count: n) // Записать, есть ли ферзь в столбце
    var diags1 = Array(repeating: false, count: 2 * n - 1) // Записать, есть ли ферзь на главной диагонали
    var diags2 = Array(repeating: false, count: 2 * n - 1) // Записать, есть ли ферзь на побочной диагонали
    var res: [[[String]]] = []
