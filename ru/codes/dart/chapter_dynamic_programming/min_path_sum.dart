...
int minPathSumDFS(List<List<int>> grid, int i, int j) {
  ...
  if (i < 0 || j < 0) {
    // В Dart тип int представляет целые числа фиксированного диапазона, поэтому значения «бесконечность» не существует
...
// Полный перебор
  ...
  print("Минимальная сумма пути от левого верхнего до правого нижнего угла равна $res");
