...
![Загрузка VS Code с официального сайта](installation.assets/vscode_installation.png){ class="animation-figure" }
...
![Установка расширений VS Code](installation.assets/vscode_extension_installation.png){ class="animation-figure" }
