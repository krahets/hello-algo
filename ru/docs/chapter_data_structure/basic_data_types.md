...
Обрати внимание: в таблице выше приведены данные именно для базовых типов данных Java. В каждом языке программирования свои определения типов, поэтому объем памяти, диапазон значений и значения по умолчанию могут различаться.
...
- В C и C++ размер базовых типов данных явно не зафиксирован и зависит от реализации и платформы. В таблице выше приведены данные для модели LP64 [data model](https://en.cppreference.com/w/cpp/language/types#Properties), используемой в 64-битных Unix-системах, включая Linux и macOS.
