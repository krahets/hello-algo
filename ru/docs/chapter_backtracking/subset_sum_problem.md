...
![Процесс backtracking для задачи о сумме подмножеств I](subset_sum_problem.assets/subset_sum_i.png){ class="animation-figure" }

<p align="center"> Рисунок 13-12 &nbsp; Процесс backtracking для задачи о сумме подмножеств I </p>
...
![Процесс backtracking для задачи о сумме подмножеств II](subset_sum_problem.assets/subset_sum_ii.png){ class="animation-figure" }

<p align="center"> Рисунок 13-14 &nbsp; Процесс backtracking для задачи о сумме подмножеств II </p>
