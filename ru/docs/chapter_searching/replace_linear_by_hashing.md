...
![ЛЛинейный поиск для нахождения двух чисел, сумма которых равна заданному](replace_linear_by_hashing.assets/two_sum_brute_force.png)
...
=== "<1>"
    ![Использование вспомогательной хеш-таблицы для нахождения двух чисел, сумма которых равна заданному](replace_linear_by_hashing.assets/two_sum_hashtable_step1.png)
