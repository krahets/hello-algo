...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(name: "hash_map_chaining", path: "chapter_hashing", sources: ["hash_map_chaining.swift"]),
        .executableTarget(name: "hash_map_open_addressing", path: "chapter_hashing", sources: ["hash_map_open_addressing.swift"]),
        // chapter_tree
