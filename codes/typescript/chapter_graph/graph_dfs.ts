...
const graphDFS = (graph: any, startVet: Vertex): Vertex[] => {
    // 顶点遍历序列
    const res: Vertex[] = [];
    // 哈希表，用于记录已被访问过的顶点
...
/* 初始化无向图 */
const v: Vertex[] = Vertex.valsToVets([0, 1, 2, 3, 4, 5, 6]);
const edges: Vertex[][] = [[v[0], v[1]], [v[0], v[3]], [v[1], v[2]],
...
/* 深度优先遍历 DFS */
const res: Vertex[] = graphDFS(graph, v[0]);
console.log("\n深度优先遍历（DFS）顶点序列为");
