...
### Logarithmic Order $O(\log n)$ {data-toc-label="Logarithmic Order O(log n)"}
...
### Linear-Logarithmic Order $O(n \log n)$ {data-toc-label="Linear-Logarithmic Order O(nlog n)"}
...
### Factorial Order $O(n!)$ {data-toc-label="Factorial Order O(n!)"}
